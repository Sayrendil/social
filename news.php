        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../social/vendor/posts/create.php" method="POST" enctype="multipart/form-data" name="create_post">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="jumbotron">
                ...
                <img src="/social/views/images/<?= $post[3] ?>" alt="" class="img-fluid">
                <hr class="my-4">
                <p><?= $post[2] ?></p>
                <a class="btn btn-primary btn-lg" href="/views/posts/post.php?id=<?= $post[0] ?>">Подробнее</a>
            </div>
            <?php
                }
            ?>
